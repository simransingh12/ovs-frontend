...
class ByTypeAllium extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByTypeAllium()
        .then((res) => {
    ...
    render() {
        return (
            ...
            <h2 className="heading">Vegetable List of type Allium</h2>
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List of type Allium</h2>
