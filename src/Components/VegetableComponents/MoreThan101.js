...
import VegetableService from '../../services/VegetableService';
 class MoreThan101 extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByGreaterThan101Price()
        .then((res) => {
    ...
    render() {
        return (
            ...
            <h2 className="heading">Vegetable List Greater than 101</h2>
