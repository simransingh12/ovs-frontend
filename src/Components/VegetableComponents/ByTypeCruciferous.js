...
import VegetableService from '../../services/VegetableService';
 ...
 class ByTypeCruciferous extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByTypeCruciferous()
        .then((res) => {
    ...
    render() {
        return (
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List of type Cruciferous</h2>
...
export default ByTypeCruciferous
