...
class ByTypeMarrow extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByTypeMarrow()
        .then((res) => {
    ...
    render() {
        return (
            ...
            <h2 className="heading">Vegetable List of type Marrow</h2>
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List of type Marrow</h2>
