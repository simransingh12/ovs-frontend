...
class ByTypeEdiblePlantSteam extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByTypeEdiblePlantSteam()
        .then((res) => {
    ...
    render() {
        return (
            ...
            <h2 className="heading">Vegetable List of type EdiblePlantSteam</h2>
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List of type EdiblePlantSteam</h2>
...
export default ByTypeEdiblePlantSteam
