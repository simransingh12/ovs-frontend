...
class ByTypeRoot extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByTypeRoot()
        .then((res) => {
    ...
    render() {
        return (
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List of type Root</h2>
