...
import VegetableService from '../../services/VegetableService';
 ...
 class LessThan20 extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        VegetableService.getVegetableByLessThan20Price()
        .then((res) => {
    ...
    render() {
        return (
            ...
            <h2 className="heading">Vegetable List Less than 20</h2>
            ...
            // </div>
            // <div>
            //     <h2 className="text-center">Vegetable List Less than 20</h2>
